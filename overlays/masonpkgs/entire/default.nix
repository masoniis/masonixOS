...
let
  ...
  sources = {
    "x86_64-linux" = {
      url =
        "https://github.com/entireio/cli/releases/download/v${version}/entire_linux_amd64.tar.gz";
      hash = "sha256-u13eERmBMz7L6+W28/TdWEjRn5vepoCI1j/tBM7lZmE=";
    };
    "aarch64-linux" = {
      url =
        "https://github.com/entireio/cli/releases/download/v${version}/entire_linux_arm64.tar.gz";
      hash = "sha256-mG2uqoSWlOiZnWiZPtzlDqWityIC6ynfuvJcOi//YN0=";
    };
    "x86_64-darwin" = {
      url =
        "https://github.com/entireio/cli/releases/download/v${version}/entire_darwin_amd64.tar.gz";
      hash = "sha256-maC4lip/botIu5WL21STh5C8cYQpwsv0A4VEH8nhLT4=";
    };
    "aarch64-darwin" = {
      url =
        "https://github.com/entireio/cli/releases/download/v${version}/entire_darwin_arm64.tar.gz";
